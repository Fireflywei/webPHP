    ...
    <div class="tab">
      ...
      <div class="tab-body">
        ...
        <div class="tab-panel active" id="tab-set">
        	<form method="post" class="form-x" action="doAdminAction.php?act=addArticle" enctype="multipart/form-data">
				
                <div class="form-group">
                    <div class="label"><label for="sitename">文章标题</label></div>
                    <div class="field">
                    	<input type="text" class="input" id="art_title" name="art_title" size="50" placeholder="文章名称"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        ...
                        <?php for($i=0;$i<count($cates);$i++){?>
                         <option value="<?php echo $cates[$i]['cat_id']?>"><?php echo $cates[$i]['cat_name']?></option>  
                        <?php }?>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                    	<input type="text" class="input" id="art_author" name="art_author" size="50" placeholder="文章作者" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="label"><label for="title">文章类型</label></div>
                    <div class="field">
                    	<input type="radio" name="art_type" value="0" checked/>普通文章<input type="radio" name="art_type" value="1"/>推荐文章
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                    	<input type="radio" name="art_open" value="0" checked/>显示<input type="radio" name="art_open" value="1"/>隐藏
                    </div>
                </div>
                <div class="form-group">
                    <div class="label"><label for="keywords">文章简介</label></div>
                    <div class="field">
                      <textarea name="description" cols="90" rows="5"></textarea>
                    </div>
                </div>
                <div class="form-group">
